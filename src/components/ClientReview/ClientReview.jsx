...
//                   <div
//                     key={i}
//                     className="w-6 h-6 rounded-full bg-slate-200 border-2 border-white shadow-sm overflow-hidden"
//                   >
//                     <img
...
//             Join 500+ fintech companies securing their transactions with our
//             AI-driven engine.
//           </p>
//         </div>
...
//                   {/* Floating Quote Icon */}
//                   <div
//                     className={`absolute -top-5 -right-2 p-4 rounded-2xl shadow-lg transition-all duration-500
  ...
  return (
    <section className="relative overflow-hidden">
      <Container>
        ...
        >
          {testimonials.map((t, idx) => (
            <SwiperSlide key={idx} className="max-w-[380px] sm:max-w-[480px]">
              {({ isActive }) => (
                <div
                  className={`
