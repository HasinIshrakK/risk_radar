        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center relative z-10">
          ...
          <div className="space-y-8 text-left">
            ...
            <p className="text-slate-600 text-lg leading-relaxed max-w-lg font-medium">
              RiskRadar isn't just a filter; it's a proactive security layer. We
              combine human intuition with machine learning to build a
              bulletproof financial ecosystem.
            </p>

            <div className="flex flex-wrap gap-6 pt-4">
              <div className="flex flex-col">
                <span className="text-3xl font-bold text-green-700">99.9%</span>
                <span className="text-sm text-slate-500 font-semibold uppercase tracking-tighter">
                  Detection Accuracy
                </span>
              </div>
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {features.map((feature, idx) => (
              ...
              >
                <div
                  className={`w-12 h-12 rounded-2xl bg-gradient-to-br ${feature.gradient} flex items-center justify-center text-white mb-6 shadow-lg shadow-green-200/50 transition-transform group-hover:scale-110 group-hover:rotate-3`}
                >
                  {feature.icon}
                </div>
